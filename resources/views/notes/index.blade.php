<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('notes.create') }}" class="px-5 py-3 bg-pink-500 text-white rounded-2xl hover:bg-pink-400 font-bold shadow-[0_4px_0_0_#db2777] active:shadow-none active:translate-y-1 transition-all">
                + Tulis Baru 🧁
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-12 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                ...
                <div class="bg-white rounded-3xl border-4 border-pink-300 shadow-[8px_8px_0_0_#f9a8d4] flex flex-col transform transition hover:-translate-y-2 hover:shadow-[12px_12px_0_0_#f9a8d4]">
